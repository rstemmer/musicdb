...
To update the frames cache the following steps are done:
    ...
    #. Create a sun directory for the frames via :meth:`~musicdb.mdbapi.videoframes.VideoFrames.CreateFramesDirectory`
    #. Generate the frames from a video with :meth:`~musicdb.mdbapi.videoframes.VideoFrames.GenerateFrames`
    #. Generate the previews from the frames with :meth:`~musicdb.mdbapi.videoframes.VideoFrames.GeneratePreviews`
    #. Update database entry with the directory name in the database via :meth:`~musicdb.mdbapi.videoframes.VideoFrames.SetVideoFrames`
"""
...
class VideoFrames(object):
    ...
    def GenerateFrames(self, dirname, videopath):
        ...
        The total length of the video gets determined by :meth:`~musicdb.lib.metatags.MetaTags.GetPlaytime`
