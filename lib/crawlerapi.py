...
class LycraCrawler(object):
    ...
    Args:
        db: A :class:`~lib.db.lycra.LycraDatabase` database object.
    ...
    Raises:
        TypeError: If the *db* argument is not of type :class:`~lib.db.lycra.LycraDatabase`
    ...
    def Crawl(self, artistname, albumname, songname, songid):
        """
        This method gets called by the lyrics manager :class:`mdbapi.lycra.Lycra`.
